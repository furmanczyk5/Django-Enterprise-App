...
( function() {
	CKEDITOR.dialog.add( 'link', function( editor ) {
        ...
        relationship = dialog.getContentElement('advanced', 'advRel'),
				value = this.getValue();
			...
			popupFeatures.hide();
			targetName.setValue( '' );
			relationship.getElement().getElementsByTag('input').getItem(0).setValue('');
			...
			switch ( value ) {
				...
				case 'popup':
					...
					break;
        case '_blank':
          relationship.getElement().getElementsByTag('input').getItem(0).setValue('noopener');
